...
################################################################
# This is a generated script based on design: blinking
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xc7a35tcsg325-2L
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name blinking
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_sys [ create_bd_port -dir I -type clk -freq_hz 25000000 clk_sys ]
  set led_bb_red [ create_bd_port -dir O -from 0 -to 0 led_bb_red ]
  set led_fpga_red [ create_bd_port -dir O -from 0 -to 0 led_fpga_red ]

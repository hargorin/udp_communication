...
if {[file exists $bit_location/$project_name.ltx]} {
    set_property PROBES.FILE $bit_location/$project_name.ltx [get_hw_devices xc7a35t_0]
    set_property FULL_PROBES.FILE $bit_location/$project_name.ltx [get_hw_devices xc7a35t_0]
}

# Add bit file
set_property PROGRAM.FILE $bit_location/$project_name.bit [get_hw_devices xc7a35t_0]
